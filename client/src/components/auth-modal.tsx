...
import { Eye, EyeOff, Mail, Lock, User, Bell, Shield } from "lucide-react";
...
export default function AuthModal({ isOpen, onClose, onAuthSuccess }: AuthModalProps) {
  ...
  const handleSignIn = (e: React.FormEvent) => {
    ...
    onAuthSuccess({
      ...
      firstName: "Demo",
      lastName: "User",
      role: signInData.email === "jusperkato@gmail.com" ? "admin" : "user"
    });
    onClose();
  };
  ...
  const handleSignUp = (e: React.FormEvent) => {
    ...
    toast({
      title: "Account created!",
      description: "Welcome to Magala Media!",
    });
    onAuthSuccess({
      id: 2,
